...
//   // Handle file change when user selects a new file
...
//         // Update mediaFiles and mediaURLs arrays
...
//       // Ensure there's always at least one upload slot
...
//   // Handle adding a new media upload slot
//   const handleAddMedia = useCallback(() => {
//     setMediaFiles((prev) => [...prev, { file: null, type: null }]);
...
//   // Handle the upload process for all media files
//   const handleUploadImages = async () => {
//     try {
//       const validFiles = mediaFiles.filter((media) => media.file !== null);
...
//       if (validFiles.length === 0) {
//         toast("Error", {
//           description: "Please select media files to upload",
//         });
//         return [];
//       }

//       // Upload files using the enhanced upload handler
//       const results = await handleUploadMedia({
//         mediaFiles: validFiles,
//         onProgress: (progress, fileName) => {
//           setOverallProgress(progress);
//         },
//         onComplete: (results, failedUploads) => {
