    ...
    <div className="bg-hero bg-[#2A0144] min-h-screen ">
      <div className="md:px-10 px-5">
        ...
        <div className="flex flex-col gap-5 px-5 text-white pt-5 ">
          ...
          <div className="">
            <p className="font-bold md:text-xl text-[13px] py-4">
              Upload Property Live Location
            </p>
            <img src="/images/map.svg" className="w-full " alt="image" />
          </div>
          ...
          <div className="flex  items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="font-bold text-xl">Adams Cane</p>
                <p>Estate Agent</p>
              </div>
            </div>
